...
enum class NetworkEvent {
    ...
    WifiConfigModeEnter,   // WiFi config mode entered
    WifiConfigModeExit,    // WiFi config mode exited
    ModemDetecting,        // Cellular modem detecting
    ModemErrorNoSim,       // No SIM card
    ModemErrorRegDenied,   // Registration denied
    ModemErrorInitFailed,  // Modem init failed
    ModemErrorTimeout,     // Modem timeout
};
