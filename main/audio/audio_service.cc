...
void AudioService::Initialize(AudioCodec* codec) {
    ...
    esp_timer_create_args_t audio_power_timer_args = {
        .callback = [](void* arg) {
            ...
            xEventGroupSetBits(audio_service->event_group_, AS_EVENT_POWER_CHECK);
        },
        .arg = this,
...
void AudioService::AudioInputTask() {
    while (true) {
        EventBits_t bits = xEventGroupWaitBits(event_group_, AS_EVENT_AUDIO_TESTING_RUNNING |
            AS_EVENT_WAKE_WORD_RUNNING | AS_EVENT_AUDIO_PROCESSOR_RUNNING | AS_EVENT_POWER_CHECK,
        ...
        // Handle power check in this task context (safe for mutex operations)
        if (bits & AS_EVENT_POWER_CHECK) {
            xEventGroupClearBits(event_group_, AS_EVENT_POWER_CHECK);
